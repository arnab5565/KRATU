 ...
 * Note 2:CTO needs to go through line 3279 and make the paste the link of the desired documentation           # 
...
function setupKratu() {
    ...
    var notification = new Notification('SUCCESS MESSAGE FROM KRATU', {
        body: 'Successfully loaded KRATU, hope you shall enjoy for more information click here'

    });
    notification.onclick = () => {
        location.replace("aboutus/aboutus.html");
    };
